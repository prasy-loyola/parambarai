...
CREATE VIEW RELATIONSHIP_WITH_DETAILS as
 SELECT DISTINCT R.ID ID,R.RELATIONSHIP ,P1.NAME P1_NAME, p1.id p1_id,P1.GENDER P1_GENDER,P1.STORIES P1_STORIES, P2.NAME P2_NAME,p2.id p2_id, P2.GENDER P2_GENDER, P2.STORIES P2_STORIES
 FROM RELATIONS R
 JOIN PERSON P1
 ON R.PERSON1=P1.ID
 JOIN PERSON P2
